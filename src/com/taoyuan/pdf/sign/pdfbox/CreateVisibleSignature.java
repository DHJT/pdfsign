package com.taoyuan.pdf.sign.pdfbox;
/*
...
public class CreateVisibleSignature extends CreateSignatureBase
{
            ...
            IOException, NoSuchAlgorithmException, UnrecoverableKeyException
    {
    	...
    	args=new String[]{"e://pdf.p12","123456","e://demo.pdf","e://zhang.png"};
        // generate with
        ...
        try (FileInputStream imageStream = new FileInputStream(args[3]))
        {
            ...
            page = 1;
            signing.setVisibleSignDesigner(args[2], 50, 100, -50, imageStream, page);
        }
